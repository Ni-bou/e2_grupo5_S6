...
SECRET_KEY = 'django-insecure-r7k09izc(6oozdin5h#$-+%g(w$45%^wo6f)vag39s6t4i)yb#'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication', #Agrega esta linea para la autenticacion de tokens
    ],
}
